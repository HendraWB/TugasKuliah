...
public class AplikasiToko extends JFrame {
    ...
    AplikasiToko() {
        ...
        frmDaftarCustomer.setLocation(dimensi.width/2-frmDaftarCustomer.getWidth()/2,dimensi.height/2-frmDaftarCustomer.getHeight()/2);
        ...
        frmJualDaftarBarang = new JFrame("DaftarBarang");
        frmJualDaftarBarang.setBounds(0,0,450,350);
        frmDaftarBarang.setLocation(dimensi.width/2-frmJualDaftarBarang.getWidth()/2,dimensi.height/2-frmJualDaftarBarang.getHeight()/2);
        frmDaftarBarang.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        frmDaftarBarang.setAlwaysOnTop(true);
        ...
        frmJualDaftarCustomer.setLocation(dimensi.width/2-frmJualDaftarCustomer.getWidth()/2,dimensi.height/2-frmJualDaftarCustomer.getHeight()/2);
        ...
        TblBarangDaftar.setBounds(226,16,70,25);
        ...
        /*Pengaturan tampilan Form DaftraCustomer */
        ...
        TblDaftarCustomerBatal.setBounds((frmDaftarCustomer.getWidth()/2)+20,frmDaftarCustomer.getHeight()-85,80,30);
        ...
        /*Menampilkan tombol di from Customer */
        ...
        TblJualDaftarCustomerPilih.setBounds((frmJualDaftarCustomer.getWidth()/2)-100,frmJualDaftarCustomer.getHeight()-85,80,30);
        ...
        TblPenjualanCancel.setBounds(540,420,80,40);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (M.getText().equals("Barang")) {
                ...
                if (M.getText().equals("Login")) {
                    frmLogin.setBounds((frmMDI.getWidth()/2)-(frmLogin.getWidth()/2),(frmMDI.getHeight()/2)-(frmLogin.getHeight()/2),frmLogin.getWidth(),frmLogin.getHeight());
    ...
    /*Class untuk memproses ActionEvent dari tombol di form Daftar Customer di form Customer */
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (TblPilih.getText().equals("Pilih")) {
                if (TabelDaftarCustomer.getSelectedRow()>=0) {
                    TxtKodeCustomer.setText((String)TabelDaftarCustomer.getModel().getValueAt(TabelDaftarCustomer.getSelectedRow(), 0));
                    ...
                    if (!JDBC_Err) {
                        try {
                            ...
                            if (rset.getRow()>0) {
                                ...
                                rset.close();
                                ClearFormCustomer();
                                JOptionPane.showMessageDialog(null, "Kode cutomer tidak ada");
                            }
                        } catch (Exception ex) {
                            JOptionPane.showMessageDialog(null, "Tidak dapat membuka tabel TbCustomer\n"+ex,"Kesalahan",JOptionPane.ERROR_MESSAGE);
                        }
            ...
            if (TblPilih.getText().equals("Daftar")) {
                ...
                if (!JDBC_Err) {
                    try {
                        ...
                        while (rset.next()) {
                            ModelTabelDaftarBarang.insertRow(ModelTabelDaftarBarang.getRowCount(), new java.lang.Object[] {rset.getString("KodeBarang"),rset.getString("NamaBarang"),rset.getString("SatuanBarang")});
                        }
            ...
            if (TblPilih==TblUserAccountSave) {
                ...
                if (bufUserID.length()>0) {
                    ...
                    while (bufHakAkses.length() < 10) {
                        bufHakAkses = bufHakAkses.concat(Character.toString((char)Math.round(Math.random()*225)));
                    }
                        ...
                        try {
                            ...
                            if (rset.getRow()>0) {
                                ...
                                if (TombolOpsi==JOptionPane.OK_OPTION) {
                                    ...
                                    TombolOpsi = JOptionPane.showConfirmDialog(null, PasswordField, "Ketik Ulang Password", JOptionPane.OK_CANCEL_OPTION);
                                    if (TombolOpsi==JOptionPane.OK_OPTION) {
                                        ...
                                        if (inputPassword.equals(retypePassword)) {
                                            ...
                                            SQLStatemen = "insert into TbUser values ('"+TxtIDUserUserAccount.getText()+"','"+TxtNamaUserUserAccount.getText()+"','"+inputPassword+"','"+bufHakAkses+"')";
                                            sta = cn.createStatement();
                                            int simpan = sta.executeUpdate(SQLStatemen);
                                            if (simpan==1) {
                                                JOptionPane.showMessageDialog(null, "Sudah tersimpan");
                ...
                if (!JDBC_Err) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Tdak dapat membuka tabel TbUser\n"+ex, "Kesalahan", JOptionPane.ERROR_MESSAGE);
                    }
                }
            ...
            if (TblPilih==TblJualCustomerDaftar) {
                ...
                if (!JDBC_Err) {
                    try {
                        ...
                        while (rset.next()) {
                            ModelTabelJualDaftarCustomer.insertRow(ModelTabelJualDaftarCustomer.getRowCount(), new java.lang.Object[] {rset.getString("KodeCustomer"),rset.getString("NamaCustomer"),rset.getString("AlamatCustomer")});
                        }
                ...
                if (!JDBC_Err) {
                    try {
                        ...
                        while (rset.next()) {
                            ModelTabelJualDaftarBarang.insertRow(ModelTabelJualDaftarBarang.getRowCount(), new java.lang.Object[]{rset.getString("KodeBarang"),rset.getString("NamaBarang"),rset.getString("SatuanBarang")});
                        }
                ...
                if (ada) {
                    ...
                    ModelTabelPenjualan.insertRow(ModelTabelPenjualan.getRowCount(), new java.lang.Object[] {ModelTabelPenjualan.getRowCount()+1,TxtKodeBarangJual.getText(),TxtNamaBarangJual.getText(),TxtHargaBarangJual.getText(),TxtJumlahjual.getText(),TxtSubTotalJual.getText()});
                }
                ...
                if (!JDBC_Err) {
                    ...
                    try {
                        ...
                        if (rset.getRow()>0) {
                            ...
                            if (pilih==0) {
                                SQLStatemen = "update TbPenjualan set Tanggal='"+Tanggal 
                                    +"', KodeCustomer='"+TxtKodeCustomerJual.getText()+"', IDUser='"+IDUserAktif
                            ...
                            sta.close();
                            rset.close();
                            SQLStatemen = "insert into TbPenjualan values ('"+TxtNoNotaJual.getText()+"','"+Tanggal+"','"+TxtKodeCustomerJual.getText()+"','"+IDUserAktif+"')";
                            sta = cn.createStatement();
                            simpan = sta.executeUpdate(SQLStatemen);
                            sta.close();
                        }
                        ...
                        if (diSimpan) {
                            if (simpan==1) {
                                ...
                                for (i=0; i<TabelPenjualan.getRowCount(); i++) {
                                    ...
                                    rset.next();
                                    if (rset.getRow()>0) {
                                        SQLStatemen = "update TbDetilPenjualan set Harga='" + Integer.parseInt((String)TabelPenjualan.getModel().getValueAt(i, 3))
                                            + "', Qty='"+ Integer.parseInt((String)TabelPenjualan.getModel().getValueAt(i, 4))
                                            + "' where NoNota='"+TxtNoNotaJual.getText()+"' and KodeBarang='"+(String)TabelPenjualan.getModel().getValueAt(i, 1)+"'";
                                        sta = cn.createStatement();
                                        simpan = sta.executeUpdate(SQLStatemen);
                                        sta.close();
                                    } else {
                                        SQLStatemen = "insert into TbDetilPenjualan values('"+TxtNoNotaJual.getText()
                                            +"','"+(String)TabelPenjualan.getModel().getValueAt(i,1)
                                            +"','"+Integer.parseInt((String)TabelPenjualan.getModel().getValueAt(i, 3))
                                            +"','"+Integer.parseInt((String)TabelPenjualan.getModel().getValueAt(i, 4))+"')";
                                        sta = cn.createStatement();
                                        simpan = sta.executeUpdate(SQLStatemen);
                                        sta.close();
                                    }
                ...
                if (TxtIDUserLogin.getText().trim().length()>0) {
                    ...
                    if (!JDBC_Err) {
                        try {
                            ...
                            JOptionPane
                            .showMessageDialog(null, "Tidak dapat membuka tabel TbUser\n"+ex, "Kesalahan", JOptionPane.ERROR_MESSAGE);
                        }
                    }
                }
